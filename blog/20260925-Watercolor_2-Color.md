---
title: An Absolute Beginner's Guide to Watercolor, Part 2—(Water)Color Theory
author: Jeremiah D Clark
date: 2026-09-25
slug: watercolor_2-color
tags: art
---
...
> “Some color wheels adjust the location of paints around the hue circle so that certain hues fall neatly on evenly spaced ‘spokes’. 
> In each case, the color locations are manipulated to **represent a color theory**. 
> (MacEvoy, 2015)
...
![The Artist’s Color Wheel by Bruce MacEvoy (MacEvoy, 2015a). Image from handprint.com.](../images/cwheel06.png)
...
![Left: MacEvoy’s “artist’s color wheel” with wedges showing the CMY primaries and their theoretical secondaries. Color wheel image from handprint.com, annotations by author. Right: Those wedges in isolation, showing how they align (or don’t). Image by author.](../images/ArtistColorWheel-1.png)
...
![Left: MacEvoy’s “artist’s color wheel” with the wedges adjusted to align better. Color wheel image from handprint.com, annotations by author. Right: The updated wedges in isolation, showing that they align better now. Image by author.](../images/ArtistColorWheel-2.png)
...
![A visual representation of how much more flexibility you get with six colors vs three. Images by author.](../images/BaseColors-3vs6_2.png)
...
![Arranging the primary and secondary paint colors in actual relation to each other clearly shows the difference in coverage between the complementary and split primary approaches. Roughly based on measurements from handprint.com/HP/WCL/color13.html (MacEvoy, 2015). Images by author.](../images/ColorWheelMeasured-ComplementaryVsSplit.png)
...
![The solid arrows identify the pigments of choice for each primary and secondary color. The empty arrows indicate pigments of choice for other colors. Color wheel image from handprint.com, annotations by author.](../images/ArtistColorWheel-CMYPlus.png)
