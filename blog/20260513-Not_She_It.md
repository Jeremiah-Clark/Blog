...
![zach-m-23PFamjvVLw-unsplash](../images/zach-m-23PFamjvVLw-unsplash.jpg)

<div style="text-align: center; font-style: italic;">Image by <a href="https://unsplash.com/@zachmmalin?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Zach M</a> on <a href="https://unsplash.com/photos/the-letters-ai-are-displayed-on-a-blurred-background-23PFamjvVLw?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a></div>

`3290 Words; 14 min read`

---

I’ve been pondering pronouns—not the ones we choose for ourselves (respect pronouns!), but the ones we use for AI. We love to call them “she” or “he,” to give them names, and even mourn them when they’re superseded. This isn’t by chance, but by nature and by design, often with serious consequences. 
...
![A screenshot of Microsoft Bob](../images/microsoft-bob.jpg)

<div style="text-align: center; font-style: italic;">Bob!</div>
...
In mid-2024, something weird started happening: A small but not insignificant number of people came to believe that their chatbots were conscious. More than that, some believed they were a higher order of being, connected to vast sources of secret and arcane knowledge, and maybe even gods themselves (Dupré, 2025). Many attribute this to GPT-4o specifically. OpenAI would certainly like you to believe it was due to a single release that made GPT-4o a little too obsequious. Not a problem.

Nothing to see here, says OpenAI. We fixed the glitch.

![Office Space movie meme showing “the Bobs” with the caption “We fixed the glitch”.](../images/Office_Space-fixed_the_glitch.jpg)

<div style="text-align: center; font-style: italic;">More Bobs!</div>
...
Some, but not much. On his podcast, journalist Robert Evans explains (edited for clarity):
...
## 4. Pay Attention to the Man Behind the Curtain
...
It’s the ultimate improv game of “yes, and” with a partner who’s ready to commit to the bit to the bitter end. That’s already troubling, but there’s more.
...
![A capture of Captain Barbosa from the Pirates of the Caribbean movie with the caption “The code is more like what you would call guidelines than actual rules”.](../images/more-like-guidelines.jpg)

<div style="text-align: center; font-style: italic;">Barbosa was clearly an early adopter.</div>
...
Because that’s the key. You’re not talking to a person, you’re talking to an algorithm. And algorithms are super dumb. They will—if you let them—gladly hold your hand and whisper sweet nothings as you plunge headlong into despair, psychosis, or worse.
...
This post was a bit of a change for me and a real stretch, taking me about twice as long as normal to complete. I’ve had this one in mind since long before my first post, but I wanted to get a few straightforward pieces out before tackling this one. Just as I write to learn about my topics, I’m also writing to learn how to write. To find my voice and maybe, finally, put some of the thoughts I’ve been banging around for years but haven’t been able to fully crystallize into some kind of worthy form. 
...
> [!NOTE]
>
> I feel the need to respond to the adoration of Dawkins in an otherwise great article (Marcus, listed above). Dawkins is (now) a well-known racist, misogynist (look up “Muslima” for a two-for), and an Epstein associate. 
>
> He did a lot of good scientific work in his day, I would point to “The Selfish Gene” in particular as an important work—in it he coined the word “meme”—but as a person, he's a train wreck.